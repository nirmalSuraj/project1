                ...
                <div class='col-lg-6 col-sm-12 form'>
                    <form action='$_srv' method='post'>
                       <h1>Aanpassen</h1>
                        ...
                        <input type='text' id='bedrijf' name='bedrijf'  value='{$_row['d_naam']}' required  >
                        <label for='btw'>BTW</label>
                        <input type='text' id='btw' name='btw' value='{$_row['d_btw']}' required >
                         <label for='straat'>Straat</label>
                        <input type='text' id='straat' name='straat' value='{$_row['d_straat']}' required >
                        <label for='huisnummer'>Gebouwnummer</label>
                        <input type='text' id='nr' name='nr' value='{$_row['d_huisNummer']}' size='10' required >
