            ...
            <div class="container-fluid" id="nav" >
                ...
                <div class="row" id="nav1">
                    ...
                    <ul >
                        ...
                        {if $menu[teller].d_link eq 'home_klant.php'  }
                        <li> <a href="{$menu[teller].d_link}"><i class="{$menu[teller].d_item}"  style="font-size:24px; color:#fff; padding: 0px;"></i></a></li>

                        {/if}

                          {if $menu[teller].d_item != 'fa fa-shopping-cart' and $menu[teller].d_link != 'home_klant.php' and $menu[teller].d_item != 'Afrekenen' and $menu[teller].d_item != 'Aanpassen' }
